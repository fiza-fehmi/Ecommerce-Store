...
const Card = ({
  ...
  return (
    <Link
      to={`/products/${id}`}
      className="block w-[200px] border border-gray-600/20 rounded-lg cursor-pointer transition-all duration-300 overflow-hidden ease-in group p-2 bg-[#FFFDF9] shadow-[0_4px_18px_rgba(31,32,56,0.10)]"
    >
