...
const Leftbar = () => {
  ...
  return (
    <div className={`bg-[#FFFDF9] transition-all duration-400 ease-in-out overflow-hidden ${expanded ? "w-64" :"md:w-16 w-12"}`}>
      <div className={`flex py-2 px-4 shadow-sm border-2 border-[#EAEAEA]  md:rounded-t-lg transition-all duration-400 ease-in-out ${expanded ? " w-full justify-between" :"md:w-16 w-12 bg-[#6D4AFF] justify-center"}`}>
      ...
      <div className={`lower-panel border-l-2 border-b-2 border-r-2 border-[#EAEAEA] flex flex-col items-center shadow-sm px-3 rounded-b-lg py-4 transition-all duration-300 ease-in-out
        ${expanded ? "w-full" : "md:w-16 w-12 pt-0"}`}>
        ...
        <div className={`bg-[#EAE4F7] h-36 rounded-lg justify-center overflow-hidden gap-1 w-44 px-3 flex flex-col items-center  transition-all duration-400 ease-in-out ${expanded ? "opacity-100 h-36" :"opacity-0 h-0"}`}>
          <div className={`h-14 w-12 rounded-full bg-[#FFFDF9] flex justify-center items-center $`}>
