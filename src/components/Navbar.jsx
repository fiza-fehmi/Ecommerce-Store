...
const Navbar = ({ menuToggle, setMenuToggle ,cartItems }) => {
    ...
    <nav className="md:sticky transition-all duration-200 ease-in top-0 z-50 bg-[#FFFDF9] border-b border-[#EAEAEA] shadow-sm relative">
      <div className="max-w-[1440px] mx-auto h-20 sm:h-20 flex items-center justify-between px-3 sm:px-6">
        ...
        <div className="hidden lg:flex items-center gap-5">
          ...
          <button
            onClick={btnClick}
            className="flex items-center gap-2 active: bg-[#6D4AFF] hover:bg-[#5A38EA] transition text-white rounded-xl px-4 py-3 cursor-pointer"
          >
        ...
        <div className="flex lg:hidden items-center gap-4">
          ...
          <button
            onClick={btnClick}
            className="relative bg-[#6D4AFF] text-white px-3 py-2 rounded-xl"
          >
